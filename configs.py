cfg = {}
cfg['input_dim'] = 8 # input dimension to LSTM
cfg['hidden_dim'] = 8 # hidden dimension for LSTM
...
cfg['batch_size'] = 8 # batch size of input
...
cfg['max_len'] = 999 # maximum character length of the generated reviews
